...
/** Benchmark-only installation access for the experimental Vector UTF-8 scan provider. */
public final class VectorUtf8ScanProviderBenchmarkAccess {
  private static final Utf8ScanProvider VECTOR_PROVIDER = new VectorProvider();

  private VectorUtf8ScanProviderBenchmarkAccess() {}

  /** Installs the benchmark-only Vector provider for subsequently constructed scanners. */
  public static void install() {
    Utf8InputScanner.installScanProviderForBenchmark(VECTOR_PROVIDER);
  }

  /** Restores native SWAR for subsequently constructed scanners. */
  public static void clear() {
    Utf8InputScanner.installScanProviderForBenchmark(null);
  }

  private static final class VectorProvider implements Utf8ScanProvider {
