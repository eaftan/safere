...
`ASCII_WORD_BOUNDARY_COMBINING_MARK` and `OPAQUE_REGION_CRLF_PAIR_CONTEXT` as
known intentional implementation-detail divergences; other generated
divergences are reported as `UNKNOWN`.
