...
final class ByteVectorScan {
  ...
  static int lastIndexOfAsciiTriple(
      byte[] bytes, int offset, int length, byte b0, byte b1, byte b2, int fromIndex, int toIndex) {
    return lastIndexOfAsciiTriple(SPECIES, bytes, offset, length, b0, b1, b2, fromIndex, toIndex);
  }
  ...
  static int lastIndexOfAsciiTriple(
    ...
    if (b0 == b1) {
      return lastIndexOfAsciiPair(species, bytes, offset, length, b0, b2, fromIndex, toIndex);
    }
    int speciesLen = species.length();
    ByteVector v0 = ByteVector.broadcast(species, b0);
    ByteVector v1 = ByteVector.broadcast(species, b1);
