...
4. Separate already-known intentional classes from unknown classes. Use existing project tests,
   `INTENTIONAL_DIVERGENCES.md`, and `docs/DESIGN_DECISIONS.md` to avoid reopening decisions
   already made.
